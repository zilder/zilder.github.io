...
function balance_teams() {
    var exp_base = Settings.exp_transform ? Settings.exp_base : 0;
...
function exp_transform_change() {
	var enabled = document.getElementById("exp_transform").checked;
	var input = document.getElementById("exp_base");
...
function on_balance_worker_message(e) {
	...
	if ( event_type == "progress" ) {
		...
		if ( result_struct.is_successfull ) {
			...
			team1_value = result_struct.team1_value;
			team2_value = result_struct.team2_value;
...
function update_teams_sr() {
	var team1_sr = calc_team_sr(team1, team1_slots);
	var team2_sr = calc_team_sr(team2, team2_slots);

    // If calculated team value is non-empty print both values
	team1_sr = team1_value > 0 ? team1_sr + '/<strong>' + team1_value + '</strong>': team1_sr;
	team2_sr = team2_value > 0 ? team2_sr + '/<strong>' + team2_value + '</strong>' : team2_sr;

	document.getElementById("team1_sr").innerHTML = team1_sr;
	document.getElementById("team2_sr").innerHTML = team2_sr;
}
